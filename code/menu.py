...
class menu:
    ...
    def run(self, ):
        menu_option = 0
        pygame.mixer_music.load('./asset/Menu.mp3')  # carregamdo som do Menu
        pygame.mixer_music.play(-1)  # toacndo musica carregada
        while True:
            # DRAW IMAGES
            self.window.blit(source=self.surf, dest=self.rect)  # desenho da imagem de background
            self.menu_text(50, "Mountain", COLOR_ORANGE, ((WIN_WIDTH / 2), 70))  # texto do Menu
